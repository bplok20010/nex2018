define(['exports', './core', '../shared/util'], function (exports, _core, _util) {
    'use strict';

    exports.__esModule = true;

    exports['default'] = (0, _core.define)('EventObject', {
        ...
        initEventConfig: function () {
            ...
            (0, _util.each)(opt, function (obj, event) {
        ...
        addListener: function (type, func, context) {
            ...
            if (!(0, _util.isFunction)(func) || func === _util.noop) {
                return false;
            }
        ...
        removeListener: function (type, id) {
            ...
            if ((0, _util.isNullOrUndef)(id)) {
                if (ext === '') {
                    events[type] = [];
                } else {
                    events[type] = (0, _util.filter)(listeners, function (e, i) {
                        if (e.ext !== ext) {
                            return true;
                        }
                    });
        ...
        emit: function (event) {
            ...
            if (!event || !(0, _util.isString)(event)) {
                return;
            }
            //事件名映射处理
            //eventMaps
